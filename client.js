...
Vue.component('subscription-selection-control', {
	...
	data: () => ({
		...
		wellKnownAddresses: [
			{ name: 'host4', value: 'TA5FW3OLFSDH3CR67BNMF2YRQHXVGPWC3TP7IVBG' },
			{ name: 'host5', value: 'TCHD4NLVHJI5MFNHLW7NDGNVHDJ44B2ANJOPWJHQ' },
			{ name: 'host6', value: 'TCOVEND5NFSWP33YDUKRTEELH7Y3ILOHX7GV23FV' },
			{ name: 'host7', value: 'TCOWBJXJYVLKFJOJU3QH7RSDXW7SRDN5CGQOFGQ6' },

			{ name: '?', value: 'TCOWBJXJYVLKFJOJU3QH7RSDXW7SRDN5CGQOFGQ6' },
			{ name: '?', value: 'TCOVEND5NFSWP33YDUKRTEELH7Y3ILOHX7GV23FV' },
			{ name: '?', value: 'TCHD4NLVHJI5MFNHLW7NDGNVHDJ44B2ANJOPWJHQ' }
		],

		address: 'TCOWBJXJYVLKFJOJU3QH7RSDXW7SRDN5CGQOFGQ6', // host4
...
Vue.component('web-socket-connection-control', {
	...
	data: () => ({
		wellKnownHosts: [
			{ name: 'host1', value: 'api-01.us-east-1.testnet-0951-v1.symboldev.network' },
			{ name: 'host2', value: 'api-01.us-west-2.testnet-0951-v1.symboldev.network' },
